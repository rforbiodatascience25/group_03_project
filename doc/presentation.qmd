...
Slide 7 \## Results – Boxplots for expression per gene in survivors vs non-survivors

![](survival_boxplots_day1.png){fig-align="center"}

Slide 8 \## Results – Difference in day 1 gene expression in survivors vs non-survivors

![](expression_difference_day1.png){fig-align="center"}

Slide 9

## Results – Expression per gene across disease status
...
# protegemos contra padj = 0 al graficar -log10
...
ggplot(volcano_simple, aes(x = log2FC, y = -log10(padj_plot))) +
