...
write_tsv(df_ed, "../data/01_expression_data.tsv")
```
...
write_tsv(pheno_data, "../data/01_phenotype_data.tsv")
```
...
write_tsv(feature_data, "../data/01_feature_data.tsv")
```
...
write_tsv(x = platform_table, 
          file = '../data/01_platform_table.tsv')
```
